module.exports = [
"[project]/tiktok-hook-ai/lib/supabase.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const supabase = createClient(("TURBOPACK compile-time value", "https://vlmzxmogbxgjcejedpcy.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_CUgbndtOUu86fgX6b4VLRg_B6JNneHh"));
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/tiktok-hook-ai/lib/supabase.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
function Home() {
    ...
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [password, setPassword] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("");
    const [user, setUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [plan, setPlan] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("free");
    const [authMode, setAuthMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("login");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser().then(({ data })=>{
            setUser(data.user);
        });
        const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange((_event, session)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadSavedHooks = async ()=>{
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("hooks").select("hook").eq("user_id", user.id).order("created_at", {
                ascending: false
            });
            if (error) {
            ...
            setSavedHooks(data?.map((item)=>item.hook) || []);
            const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("plan").eq("id", user.id).single();
            if (profile) {
    ...
    const handleAuth = async ()=>{
        if (authMode === "signup") {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email,
                password
            });
            if (error) {
            ...
            if (data.user) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("profiles").insert([
                    {
                        id: data.user.id,
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            if (error) {
    ...
    const generateHooks = async ()=>{
        ...
        if (plan !== "pro") {
            ...
            const { count, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usage_logs").select("*", {
                count: "exact",
                head: true
        ...
        try {
            ...
            if (plan !== "pro") {
                await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("usage_logs").insert([
                    {
                        user_id: user.id
                    }
                ]);
    ...
    const saveHook = async (hook)=>{
        ...
        if (!savedHooks.includes(hook)) {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("hooks").insert([
                {
                    hook: hook,
                    user_id: user.id
                }
    ...
    const deleteHook = async (hookToDelete)=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("hooks").delete().eq("hook", hookToDelete).eq("user_id", user.id);
        if (error) {
    ...
    const clearAllHooks = async ()=>{
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from("hooks").delete().neq("id", 0);
        if (error) {
            console.log(error);
            return;
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            !user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            user && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: async ()=>{
                                await __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signOut();
                                setUser(null);
                            },
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        savedHooks.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 628,
                            columnNumber: 7
                        }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$tiktok$2d$hook$2d$ai$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "grid gap-4",
...
//# sourceMappingURL=tiktok-hook-ai_0uek9xs._.js.map